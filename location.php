...
<th></th>
	<tr>
	<td><input type='text' id='location_create'
		placeholder='New Location'></td>
	<td><button onclick="
		var inField = document.getElementById('location_create');
...
?>	
	...
	<td>
	<button onclick="modify('<?php echo $row->location?>','delete');">
		Delete</button>
	</td>
...
<script>
	...
	function modify(loc,op){
		...
		xhttp.open('POST','location_modify.php',true);
		xhttp.setRequestHeader('Content-type',
			'application/x-www-form-urlencoded');
		xhttp.send('op='+op+'&location='+loc);
	}
